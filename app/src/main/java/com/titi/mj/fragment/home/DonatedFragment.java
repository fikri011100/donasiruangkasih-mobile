...
import com.titi.mj.adapter.DonatedAdapter;
...
public class DonatedFragment extends Fragment {
    ...
    void init(View view) {
        mRecycler = view.findViewById(R.id.rv_donated);
        mProgress = view.findViewById(R.id.pb_donated);
        mBtnReload = view.findViewById(R.id.btn_reload_donated);
        mImgNot = view.findViewById(R.id.iv_not_donated);
    ...
    private void getResponse() {
        ...
        final DonatedAdapter adapter = new DonatedAdapter(getContext());
        mProgress.setVisibility(View.VISIBLE);
        APIInterface apiInterface = APIClient.getClient().create(APIInterface.class);
        Call<DonatedResponse> call = apiInterface.getDonated(id, 0);
