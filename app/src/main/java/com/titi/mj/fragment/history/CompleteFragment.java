...
import com.titi.mj.fragment.utils.NotfoundFragment;
...
public class CompleteFragment extends Fragment {
    ...
    void init(View view) {
        mRecycler = view.findViewById(R.id.rv_complete);
        mProgress = view.findViewById(R.id.pb_complete);
        mBtnReload = view.findViewById(R.id.btn_reload_complete);
        mImgNot = view.findViewById(R.id.iv_not_complete);
    ...
    private void getResponse() {
        ...
        Call<DonatedResponse> call = apiInterface.getDonated(id, 2);
